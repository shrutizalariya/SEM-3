...
public class Lab15_84 {
    public static void main(String[] args) {
        ...
        while (x < 6) {
            ...
            System.out.println("Enter 2 for delete mobile number");
            System.out.println("Enter 3 for search mobile number");
            System.out.println("Enter 4 for display mobile number in ascending order ");
            System.out.println("Enter 5 for display mobile number in descending order ");
